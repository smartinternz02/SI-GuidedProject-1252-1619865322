...
const char* ssid = "Polkampally";//your wifi ssid
const char* password = "9849150178";//your password

// CHANGE TO YOUR DEVICE CREDENTIALS AS PER IN IBM BLUMIX
#define ORG "ubllw3"
#define DEVICE_TYPE "ESP32"
#define DEVICE_ID "ESP739"
#define TOKEN "ESP739-esp32-1702" //  Authentication Token OF THE DEVICE
//  PIN DECLARATIONS 
